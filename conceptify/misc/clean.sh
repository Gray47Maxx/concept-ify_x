...
#Assist
#rm -rf /system/priv-app/assist_app-release
#rm -rf /data/user/0/com.sonymobile.assist

#Basic Sleep Mode Apps
rm -rf /system/app/BasicDreams
rm -rf /data/user/0/com.android.dreams.basic
...
#rm -rf /system/priv-app/Xperia-IntelligenceEngine
#rm -rf /system/priv-app/SomcIndeviceIntelligence-release
#rm -rf /data/user/0/com.sonymobile.indeviceintelligence
#rm -rf /data/user/0/Xperia-IntelligenceEngine
...
#rm -rf /system/app/Iengine
#rm -rf /data/user/0/com.sonymobile.intelligent.iengine
